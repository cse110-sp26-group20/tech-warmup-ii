...
export const PAYLINES = [
    [[1, 0], [1, 1], [1, 2]], // Middle horizontal (index 0)
    [[0, 0], [0, 1], [0, 2]], // Top horizontal (index 1)
    [[2, 0], [2, 1], [2, 2]], // Bottom horizontal (index 2)
    [[0, 0], [1, 1], [2, 2]], // Diagonal down (index 3)
    [[2, 0], [1, 1], [0, 2]]  // Diagonal up (index 4)
];
